...
public class ParticipacaoEventoDTO {
    ...
    public ParticipacaoEventoDTO(ParticipacaoEvento participacaoEvento) {
        id = participacaoEvento.getId();
        idUsuario = participacaoEvento.getIdUsuario();
        idEvento = participacaoEvento.getIdEvento();
        tipoParticipacao = participacaoEvento.getTipoParticipacao();
    }
