...
public class CursoService {
	...
	public CursoDTO listarInscricoesCurso(Long cursoId) {
		...
		List<InscricaoDTO> inscricaoDTOs = inscricoes.stream().map(inscricao -> new InscricaoDTO(inscricao))
	...
	public ResponseEntity<MensagemResponse> excluirCurso(Long id) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new MensagemResponse("Curso excluído!"));
	}
