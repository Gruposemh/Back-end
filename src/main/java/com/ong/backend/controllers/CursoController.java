...
public class CursoController {
	...
	public ResponseEntity<MensagemResponse> cadastrarCurso(@RequestBody CursoDTO dto){
    ...
    public ResponseEntity<MensagemResponse> atualizarCurso(@PathVariable Long id, @RequestBody CursoDTO atualizado) {
